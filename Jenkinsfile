...
def upstreamProjects = [
  ...
  'news/servlet', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-news-servlet</artifactId>
  'section/model', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-section-model</artifactId>
  'section/servlet', // <groupId>com.semanticcms</groupId><artifactId>semanticcms-section-servlet</artifactId>
